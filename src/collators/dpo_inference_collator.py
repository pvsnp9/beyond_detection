    ...
    try:
        ...
        for example in examples:
            ...
            if query and caption:
                ...
                user_text = f"CAPTION: {caption}".strip()
            else:
                user_text = query
        ...
        print(f"failed to prep aya DPO message from batch: {e}")
        raise


def qwen_dpo_inference_collator(
    batch_data,
    mode: str = None,
    processor=None,
    max_length: Optional[int] = None,
    ...
    try:
        ...
        print(f"failed to prep qwen DPO message from batch: {e}")
        raise


def llama_dpo_inference_collator(
    batch_data,
    mode: str = None,
    processor=None,
    max_length: Optional[int] = None,
    ...
    try:
        ...
        print(f"failed to prep llama DPO message from batch: {e}")
        raise


def gemma_dpo_inference_collator(
    batch_data,
    mode: str = None,
    processor=None,
    max_length: Optional[int] = None,
    ...
    try:
        ...
        print(f"failed to prep gemma DPO message from batch: {e}")
        raise
